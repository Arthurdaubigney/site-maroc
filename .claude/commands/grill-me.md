...
- Look for an existing brief, `CLAUDE.md`, `BRIEF.md`, or a `.claude/skills/ux-ui-kit/reference/` folder.
- Look for an existing theme: `.claude/skills/ux-ui-kit/tokens/*.json`, `design-tokens.json`, `theme.css`.
