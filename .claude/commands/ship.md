...
1. Quality gate (must be fully green before continuing):
   - `node .claude/skills/ux-ui-kit/scripts/accuracy_report.mjs` — report the real N/N.
   - `node .claude/skills/ux-ui-kit/scripts/verify_responsive.mjs examples` — no overflow at 280/320/414.
   - `python3 .claude/skills/ux-ui-kit/scripts/check_no_emoji.py` — UI + taste + instruction surface.
