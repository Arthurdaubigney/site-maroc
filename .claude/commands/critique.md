...
```
node .claude/skills/ux-ui-kit/scripts/taste_audit.mjs <file> && node .claude/skills/ux-ui-kit/scripts/taste_audit.mjs <file> --dark
node .claude/skills/ux-ui-kit/scripts/slop_tells.mjs  <file> && node .claude/skills/ux-ui-kit/scripts/slop_tells.mjs  <file> --dark
node .claude/skills/ux-ui-kit/scripts/verify_overflow.mjs   <file|dir>
node .claude/skills/ux-ui-kit/scripts/verify_responsive.mjs <file|dir>
```
