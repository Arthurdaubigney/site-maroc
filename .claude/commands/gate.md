...
1. Run: `node .claude/skills/ux-ui-kit/scripts/accuracy_report.mjs`
...
4. For any rendered HTML touched this session, also run the pixel-truth checks
   ...
   - `node .claude/skills/ux-ui-kit/scripts/verify_states.mjs <file> [--dark]`
   - `node .claude/skills/ux-ui-kit/scripts/verify_responsive.mjs <file>`
...
They do not prove taste. Pair with `node .claude/skills/ux-ui-kit/scripts/taste_audit.mjs` + human review;
