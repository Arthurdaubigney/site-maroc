...
- Fetch the target URL using `".claude/skills/seo/scripts/claude-seo" run render_page.py "<url>" --mode auto --json` (SPA-aware SSRF-protected renderer)
- Parse with `".claude/skills/seo/scripts/claude-seo" run parse_html.py --url "<url>"` to extract SEO elements
...
- Analyze the top 10 organic results:
  - Classify each result's page type using `.claude/skills/seo-sxo/references/page-type-taxonomy.md`
...
- Read `.claude/skills/seo-sxo/references/user-story-framework.md`
...
- Read `.claude/skills/seo-sxo/references/persona-scoring.md`
...
- Read `.claude/skills/seo-sxo/references/wireframe-templates.md`
...
- [ ] URL was fetched via `".claude/skills/seo/scripts/claude-seo" run render_page.py --mode auto` (not raw curl)
