...
1. Check credentials: `".claude/skills/seo/scripts/claude-seo" run google_auth.py --check --json`
...
### Tier 0 (API Key Only)
- Run PSI + CrUX on homepage: `".claude/skills/seo/scripts/claude-seo" run pagespeed_check.py <url> --json`
- Run CrUX History for origin: `".claude/skills/seo/scripts/claude-seo" run crux_history.py <origin> --origin --json`
- Report CWV field data with traffic-light ratings

### Tier 1 (+ Service Account)
- All Tier 0 checks
- GSC top queries/pages (28 days): `".claude/skills/seo/scripts/claude-seo" run gsc_query.py --property <prop> --json`
...
- URL Inspection on homepage + key pages: `".claude/skills/seo/scripts/claude-seo" run gsc_inspect.py <url> --json`
- GSC sitemap status: `".claude/skills/seo/scripts/claude-seo" run gsc_query.py sitemaps --property <prop> --json`

### Tier 2 (Full)
- All Tier 1 checks
- GA4 organic traffic (28 days): `".claude/skills/seo/scripts/claude-seo" run ga4_report.py --property <id> --json`
- Top organic landing pages: `".claude/skills/seo/scripts/claude-seo" run ga4_report.py --property <id> --report top-pages --json`
...
```bash
".claude/skills/seo/scripts/claude-seo" run google_report.py --type full --data data.json --domain DOMAIN --format pdf --json
```
...
- Generated PDF/HTML/XLSX reports under `output_dir/` with `".claude/skills/seo/scripts/claude-seo" run google_report.py --output-dir "$output_dir"`
