...
1. Check credentials: `".claude/skills/seo/scripts/claude-seo" run matomo_auth.py --check --json`
2. Confirm the configured site ID: `".claude/skills/seo/scripts/claude-seo" run matomo_report.py check --json`
...
|---|---|
| `".claude/skills/seo/scripts/claude-seo" run matomo_report.py organic --json` | Per-day organic visits + top landing pages |
| `".claude/skills/seo/scripts/claude-seo" run matomo_report.py top-pages --json` | Top organic landing pages only |
| `".claude/skills/seo/scripts/claude-seo" run matomo_report.py device --json` | Desktop / Smartphone / Tablet split |
| `".claude/skills/seo/scripts/claude-seo" run matomo_report.py country --json` | Country breakdown (ISO-3166-1 alpha-2) |
| `".claude/skills/seo/scripts/claude-seo" run matomo_report.py referrers --json` | Channel breakdown (direct / search / website / social / campaign) + search-engine split |
| `".claude/skills/seo/scripts/claude-seo" run matomo_report.py keywords --json` | Organic search keywords (often "(not provided)") |
