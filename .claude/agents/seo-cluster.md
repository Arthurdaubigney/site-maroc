...
`.claude/skills/seo-cluster/references/hub-spoke-architecture.md`. Also produce a
...
- `.claude/skills/seo-cluster/references/serp-overlap-methodology.md`, Scoring algorithm and thresholds
- `.claude/skills/seo-cluster/references/hub-spoke-architecture.md`, Cluster structure and templates
- `.claude/skills/seo-cluster/references/execution-workflow.md`, Priority ordering and context injection
