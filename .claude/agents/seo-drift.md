...
- `".claude/skills/seo/scripts/claude-seo" run drift_baseline.py <url>` -- capture a new baseline
- `".claude/skills/seo/scripts/claude-seo" run drift_compare.py <url>` -- compare current state to baseline
- `".claude/skills/seo/scripts/claude-seo" run drift_history.py <url>` -- show change history
- `".claude/skills/seo/scripts/claude-seo" run drift_report.py <file> --output report.html` -- generate HTML report
