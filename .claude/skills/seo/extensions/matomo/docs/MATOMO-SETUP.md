...
1. **Matomo Reporting API** for organic traffic, landing pages, devices,
   ...
   `".claude/skills/seo/scripts/claude-seo" run matomo_report.py`.
2. **Live credential probe** via `".claude/skills/seo/scripts/claude-seo" run matomo_auth.py --check`
...
```bash
".claude/skills/seo/scripts/claude-seo" run matomo_auth.py --check
".claude/skills/seo/scripts/claude-seo" run matomo_report.py check --json
".claude/skills/seo/scripts/claude-seo" run matomo_report.py organic --json
```
