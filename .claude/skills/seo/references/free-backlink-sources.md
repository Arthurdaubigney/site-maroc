...
This is enforced, not advisory: `".claude/skills/seo/scripts/claude-seo" run validate_backlink_report.py` fails
...
- **Command:** `".claude/skills/seo/scripts/claude-seo" run moz_api.py`
...
- **Command:** `".claude/skills/seo/scripts/claude-seo" run bing_webmaster.py`
...
- **Command:** `".claude/skills/seo/scripts/claude-seo" run commoncrawl_graph.py`
...
- **Command:** `".claude/skills/seo/scripts/claude-seo" run verify_backlinks.py`
