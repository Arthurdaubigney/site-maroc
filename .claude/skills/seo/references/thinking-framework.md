...
- Raw HTML + rendered HTML (via `".claude/skills/seo/scripts/claude-seo" run render_page.py`)
...
- Core Web Vitals field data from CrUX (via `".claude/skills/seo/scripts/claude-seo" run pagespeed_check.py`)
...
- What does **Google's primary-source guidance** say about the
  ...
  to Google (see `.claude/skills/seo-geo/references/google-ai-optimization-guide.md`).
