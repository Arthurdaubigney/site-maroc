...
## Steps
1. Read `.claude/skills/ux-ui-kit/workflows/prototyping.md` (5-level fidelity ladder, journey mapping template, usability-testing script, sample data).
...
5. High-fi/code steps pull tokens (`.claude/skills/ux-ui-kit/tokens/*`), components (`.claude/skills/ux-ui-kit/components/*`), taste (`.claude/skills/ux-ui-kit/taste/*`), and a11y (`.claude/skills/ux-ui-kit/accessibility/*`).
