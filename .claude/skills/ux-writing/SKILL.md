...
## Steps
1. Read `.claude/skills/ux-ui-kit/content/voice-tone.md` (voice principles, tone spectrum, formulas, microcopy patterns, inclusive language, pre-ship checklist).
...
Run every line through the 10-item pre-ship checklist in `.claude/skills/ux-ui-kit/content/voice-tone.md` — do not skip it:
...
- Within character limits; translatable (no concatenation — see `.claude/skills/ux-ui-kit/accessibility/i18n-rtl.md`).
