...
produced `.claude/skills/ux-ui-kit/examples/showcase/` and `.claude/skills/ux-ui-kit/examples/terminal/`, both of which pass every
gate in both themes.
...
```bash
node .claude/skills/ux-ui-kit/scripts/measure_render.mjs <file> && node .claude/skills/ux-ui-kit/scripts/measure_render.mjs --dark <file>
node .claude/skills/ux-ui-kit/scripts/verify_states.mjs <file>  && node .claude/skills/ux-ui-kit/scripts/axe_audit.mjs --dark <file>
node .claude/skills/ux-ui-kit/scripts/verify_responsive.mjs <file> --scale=1.25
node .claude/skills/ux-ui-kit/scripts/verify_interactive.mjs <file>
node .claude/skills/ux-ui-kit/scripts/slop_tells.mjs --strict <file> && node .claude/skills/ux-ui-kit/scripts/taste_audit.mjs --strict <file>
```
...
Worked references, both gate-verified: `.claude/skills/ux-ui-kit/examples/showcase/index.html` (revenue
console) and `.claude/skills/ux-ui-kit/examples/terminal/index.html` (trading desk, ten chart types).
