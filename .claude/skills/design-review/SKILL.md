...
## Steps
1. Read `.claude/skills/ux-ui-kit/workflows/design-review.md` (rubric, scoring guide, Nielsen heuristics, process).
...
4. Run the accessibility lens with `.claude/skills/ux-ui-kit/accessibility/wcag-checklist.md`; use `.claude/skills/ux-ui-kit/scripts/contrast.py` for any color-pair doubts.
5. Check against the anti-slop tells in `.claude/skills/ux-ui-kit/taste/design-taste.md` (Banned Defaults checklist).
