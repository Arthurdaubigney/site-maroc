...
|---|---|
| `/seo matomo check` | `".claude/skills/seo/scripts/claude-seo" run matomo_auth.py --check` |
| `/seo matomo organic [site-id]` | `".claude/skills/seo/scripts/claude-seo" run matomo_report.py organic --site-id <id>` |
| `/seo matomo top-pages` | `".claude/skills/seo/scripts/claude-seo" run matomo_report.py top-pages` |
| `/seo matomo device` | `".claude/skills/seo/scripts/claude-seo" run matomo_report.py device` |
| `/seo matomo country` | `".claude/skills/seo/scripts/claude-seo" run matomo_report.py country` |
| `/seo matomo referrers` | `".claude/skills/seo/scripts/claude-seo" run matomo_report.py referrers` |
| `/seo matomo keywords` | `".claude/skills/seo/scripts/claude-seo" run matomo_report.py keywords` |
...
- During `/seo audit`, the orchestrator spawns the `seo-matomo` agent
  (analogous to `seo-google`) whenever `".claude/skills/seo/scripts/claude-seo" run matomo_auth.py
...
- Missing credentials: report which env vars / config keys are unset and
  ...
  `".claude/skills/seo/scripts/claude-seo" run matomo_auth.py --setup`.
