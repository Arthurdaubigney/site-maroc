...
All flags forward through `".claude/skills/seo/scripts/claude-seo" run unlighthouse_run.py`, which handles
...
- For LCP subpart decomposition on slow pages, use the
  `".claude/skills/seo/scripts/claude-seo" run lcp_subparts.py` workflow (Phase C).
