...
`".claude/skills/seo/scripts/claude-seo" run parse_html.py` classifies each image's lazy-loading mechanism via the
...
".claude/skills/seo/scripts/claude-seo" run iptc_ai_label.py audit ./images/ --json

# Audit a single image
".claude/skills/seo/scripts/claude-seo" run iptc_ai_label.py audit ./hero.webp --json

# Inject the AI label into an image
".claude/skills/seo/scripts/claude-seo" run iptc_ai_label.py inject ./ai-hero.webp \
