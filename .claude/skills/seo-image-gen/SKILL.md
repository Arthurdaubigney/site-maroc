...
```bash
".claude/skills/seo/scripts/claude-seo" run --extension banana presets.py list
```
...
- Log every generation: `".claude/skills/seo/scripts/claude-seo" run --extension banana cost_tracker.py log --model MODEL --resolution RES --prompt "brief"`
...
| Error | Resolution |
|-------|-----------|
| MCP not configured | Run `./extensions/banana/install.sh` or `".claude/skills/seo/scripts/claude-seo" run --extension banana setup_mcp.py --key YOUR_KEY` |
...
| MCP unavailable | Fall back: `".claude/skills/seo/scripts/claude-seo" run --extension banana generate.py --prompt "..." --aspect-ratio "16:9" --model "$NANOBANANA_MODEL"` |
| CSV batch input | Plan first: `".claude/skills/seo/scripts/claude-seo" run --extension banana batch.py --csv requests.csv --model "$NANOBANANA_MODEL"` |
