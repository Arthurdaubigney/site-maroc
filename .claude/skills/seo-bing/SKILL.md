...
|---|---|
| `/seo bing links <url>` | `".claude/skills/seo/scripts/claude-seo" run bing_webmaster.py links <url>` |
| `/seo bing compare <urlA> <urlB>` | `".claude/skills/seo/scripts/claude-seo" run bing_webmaster.py compare <urlA> <urlB>`; both properties must be registered to the API account |
| `/seo bing submit <url>` (single URL) | `".claude/skills/seo/scripts/claude-seo" run indexnow_submit.py --host ... --urls <url>` |
| `/seo bing submit-batch <file>` | `".claude/skills/seo/scripts/claude-seo" run indexnow_submit.py --host ... --urls-file <file>` |
| `/seo bing verify-indexnow` | `".claude/skills/seo/scripts/claude-seo" run indexnow_submit.py --host ... --verify-only` |
