...
```bash
".claude/skills/seo/scripts/claude-seo" run google_auth.py --check --json
```
...
**Script:** `".claude/skills/seo/scripts/claude-seo" run pagespeed_check.py <url> --json`
...
**Script:** `".claude/skills/seo/scripts/claude-seo" run pagespeed_check.py <url> --crux-only --json`

### `/seo google crux-history <url>`

25-week CrUX History trends. Shows whether CWV metrics are improving, stable, or degrading.

**Script:** `".claude/skills/seo/scripts/claude-seo" run crux_history.py <url> --json`
**Reference:** `references/pagespeed-crux-api.md`
...
**Script:** `".claude/skills/seo/scripts/claude-seo" run gsc_query.py --property <property> --json`
...
**Script:** `".claude/skills/seo/scripts/claude-seo" run gsc_inspect.py <url> --json`
...
**Script:** `".claude/skills/seo/scripts/claude-seo" run gsc_inspect.py --batch <file> --json`
...
**Script:** `".claude/skills/seo/scripts/claude-seo" run gsc_query.py sitemaps --property <property> --json`
...
**Script:** `".claude/skills/seo/scripts/claude-seo" run indexing_notify.py <url> --json`
...
**Script:** `".claude/skills/seo/scripts/claude-seo" run indexing_notify.py --batch <file> --json`
...
**Script:** `".claude/skills/seo/scripts/claude-seo" run ga4_report.py --property <id> --json`
...
**Script:** `".claude/skills/seo/scripts/claude-seo" run ga4_report.py --property <id> --report top-pages --json`
...
**Script:** `".claude/skills/seo/scripts/claude-seo" run youtube_search.py search "<query>" --json`
...
**Script:** `".claude/skills/seo/scripts/claude-seo" run youtube_search.py video <video_id> --json`
...
**Script:** `".claude/skills/seo/scripts/claude-seo" run nlp_analyze.py --url <url> --json` or `--text "..."`
...
**Script:** `".claude/skills/seo/scripts/claude-seo" run nlp_analyze.py --url <url> --features entities --json`
...
**Script:** `".claude/skills/seo/scripts/claude-seo" run keyword_planner.py ideas "<seed>" --json`
...
**Script:** `".claude/skills/seo/scripts/claude-seo" run keyword_planner.py volume "<kw1>,<kw2>" --json`
...
**Script:** `".claude/skills/seo/scripts/claude-seo" run google_report.py --type <type> --data <json> --domain <domain> --format pdf`
...
2. Save JSON output to file: `".claude/skills/seo/scripts/claude-seo" run pagespeed_check.py <url> --json > data.json`
3. Generate report: `".claude/skills/seo/scripts/claude-seo" run google_report.py --type cwv-audit --data data.json --domain <domain>`
