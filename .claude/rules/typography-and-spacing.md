...
See composite text styles in `.claude/skills/ux-ui-kit/tokens/typography.json` → `textStyle`.
...
See `.claude/skills/ux-ui-kit/tokens/spacing.json` for the full scale and semantic aliases.
