...
- Reference: `.claude/skills/ux-ui-kit/components/atoms.md`, `.claude/skills/ux-ui-kit/components/molecules.md`, `.claude/skills/ux-ui-kit/components/organisms.md`, `.claude/skills/ux-ui-kit/components/templates.md`
...
- Validate at every fidelity level (see `.claude/skills/ux-ui-kit/workflows/prototyping.md`)
- User research is not optional — see the usability testing script in `.claude/skills/ux-ui-kit/workflows/prototyping.md`

### Inclusive Design
Design for the edges, and the center benefits:
- WCAG 2.2 AA is the **minimum**, not the goal — see `.claude/skills/ux-ui-kit/accessibility/wcag-checklist.md`
...
- See ARIA implementation patterns in `.claude/skills/ux-ui-kit/accessibility/aria-patterns.md`
...
metrics differ per platform. Prove it with `node .claude/skills/ux-ui-kit/scripts/verify_responsive.mjs
...
| Level | File | Contents |
|-------|------|----------|
| Atoms | `.claude/skills/ux-ui-kit/components/atoms.md` | Button, Input, Label, Icon, Badge, Avatar, Checkbox, Radio, Toggle, Tooltip |
| Molecules | `.claude/skills/ux-ui-kit/components/molecules.md` | Form Field, Search Bar, Card, Navigation Item, Alert, Dropdown |
| Organisms | `.claude/skills/ux-ui-kit/components/organisms.md` | Header, Sidebar, Form, Data Table, Modal, Drawer |
| Templates | `.claude/skills/ux-ui-kit/components/templates.md` | Dashboard, Auth, Settings, List/Detail |
