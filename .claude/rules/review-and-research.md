...
Full rubric and process: `.claude/skills/ux-ui-kit/workflows/design-review.md`

### Heuristic Evaluation
Apply Nielsen's 10 Usability Heuristics to every review. Flag violations with the heuristic number. See `.claude/skills/ux-ui-kit/workflows/design-review.md` for the full checklist.
...
- See full methodology and scripts in `.claude/skills/ux-ui-kit/workflows/prototyping.md`
...
Full workflow: `.claude/skills/ux-ui-kit/workflows/design-to-code.md`
