...
- Reference: `.claude/skills/ux-ui-kit/frameworks/react-tailwind.md`
...
- Reference: `.claude/skills/ux-ui-kit/frameworks/nextjs.md`
...
- Reference: `.claude/skills/ux-ui-kit/frameworks/swiftui.md`
...
7. **Any framework** — Use `.claude/skills/ux-ui-kit/frameworks/adapter-protocol.md` for targets without a dedicated file; generate an adapter on demand.
8. **Output completeness** — A partial output is a broken output. Deliver full files, never placeholders (`// ... rest unchanged`). If asked for N components/screens, deliver all N. Split at clean boundaries only when length forces it, and continue to completion. (See `.claude/skills/ux-ui-kit/workflows/redesign-audit.md`.)
