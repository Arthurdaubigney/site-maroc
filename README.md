...
- `assets/js/main.js` : menu mobile, repli des photos, validation et envoi du formulaire.
...
1. **Nom de la maison** : « Dar Al Qadim » est un nom provisoire.
...
5. **Formulaire** : renseigner `data-endpoint` (Formspree ou fonction Vercel). Sans endpoint, le formulaire ouvre
   la messagerie du visiteur avec la demande pré-remplie.
